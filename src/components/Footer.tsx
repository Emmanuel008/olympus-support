      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <div className="flex flex-col space-y-3 text-sm text-gray-300">
              <div className="flex items-start space-x-3">
                ...
                <span>Oyster Plaza</span>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-white mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:255625313162" className="hover:text-white transition-colors">255625313162</a>
              </div>
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-white mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@olympus-support.co.tz" className="hover:text-white transition-colors">info@olympus-support.co.tz</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 pt-8">
          ...
          <div className="text-center text-gray-400 text-sm">
            © {new Date().getFullYear()} Olympus Support Solution Limited. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
